...
*This is v1.0.16 of the skill, published 2026-07-27. Installed copies are version-pinned; to update to the latest release, re-run `npx skills add https://app.molnify.com` (see `README.md`).*
